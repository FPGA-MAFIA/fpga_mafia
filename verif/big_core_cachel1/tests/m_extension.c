...
// for software compilation : ./build.py -dut big_core_cachel1 -test m_extension -app  -cfg big_core_rv32im
// for simulation run       : ./build.py -dut big_core_cachel1 -test m_extension -app -hw -sim -cfg big_core_rv32im
