...
string test_name;
`include "mini_core_di_tasks.vh"
`include "mini_core_di_trk.sv"
...
initial begin: test_seq
    ...
    file = $fopen({"../../../target/mini_core_di/tests/",test_name,"/gcc_files/inst_mem.sv"}, "r");
    if (!file) begin
        $error("the file: ../../../target/mini_core_di/tests/%s/gcc_files/inst_mem.sv does not exist", test_name);
