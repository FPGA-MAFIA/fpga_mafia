...
#define SCREEN_WORD_WIDTH 80
#define SCREEN_WORD_HEIGHT 60

/* Define the dimensions and initial position of the dino */
#define DINO_WIDTH 2
#define DINO_HEIGHT 8
#define DINO_INITIAL_X 10
#define DINO_INITIAL_Y (SCREEN_WORD_HEIGHT - DINO_HEIGHT)

/* Define the dimensions and initial position of the obstacles */
#define OBSTACLE_WIDTH 3
#define OBSTACLE_HEIGHT 10
#define OBSTACLE_INITIAL_X SCREEN_WORD_WIDTH
#define OBSTACLE_INITIAL_Y (SCREEN_WORD_HEIGHT - OBSTACLE_HEIGHT)
...
void playGame()
{
    ...
    while (1) {
        ...
        obst_rect->col--;
        if (obst_rect->col < 0) {
            obst_rect->col = SCREEN_WORD_WIDTH;
        }
