...
real result_ipc, result_cpi;
 ...
 pmon_file = $fopen({"../../../target/mini_core_kbd/tests/",test_name,"/trk_cpi_ipc.log"},"w");
       $fdisplay(pmon_file,"===========================================");
       ...
       $fdisplay(pmon_file,"\nSummary report");
       $fdisplay(pmon_file,"---------------------");
       $fdisplay(pmon_file, "Number of cycles: %1d\nNumber of valid instructions: %1d",mini_core_kbd_top.mini_core_kbd.mini_core_kbd_csr.csr_mcycle_high_low, mini_core_kbd_top.mini_core_kbd.mini_core_kbd_csr.csr_minstret_high_low);
       
       // calculatin IPC and CPI
       instret_high_low_real = mini_core_kbd_top.mini_core_kbd.mini_core_kbd_csr.csr_minstret_high_low;
       cycle_high_low_real = mini_core_kbd_top.mini_core_kbd.mini_core_kbd_csr.csr_mcycle_high_low;
