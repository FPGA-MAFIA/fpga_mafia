...
initial begin: test_seq
    ...
    file = $fopen({"../../../target/mini_core_kbd/tests/",test_name,"/gcc_files/inst_mem.sv"}, "r");
    if (!file) begin
        $error("the file: ../../../target/mini_core_kbd/tests/%s/gcc_files/inst_mem.sv does not exist", test_name);
