...
initial begin: trk_memory_access_gen
    #1
    $timeformat(-9, 1, " ", 6);
    trk_memory_access = $fopen({"../../../target/mini_core_kbd/tests/",test_name,"/trk_memory_access.log"},"w");
...
initial begin: trk_rf_memory_access_gen
    #1
    $timeformat(-9, 1, " ", 6);
    trk_ref_memory_access = $fopen({"../../../target/mini_core_kbd/tests/",test_name,"/trk_ref_memory_access.log"},"w");
...
initial begin: trk_reg_write_gen
    $timeformat(-9, 1, " ", 6);
    #1
    trk_reg_write = $fopen({"../../../target/mini_core_kbd/tests/",test_name,"/trk_reg_write_ref.log"},"w");
