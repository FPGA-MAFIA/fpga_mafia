...
// -----------------
//////////////////////////////////////////////////////////////////////////////////////////////////
mini_core_kbd_if mini_core_kbd_if (
...
// ----------------- 
//////////////////////////////////////////////////////////////////////////////////////////////////
mini_core_kbd_ctrl mini_core_kbd_ctrl (
  .Rst                  (Rst    ), //input
  .Clock                (Clock  ), //input
  // input instruction 
...
//////////////////////////////////////////////////////////////////////////////////////////////////
mini_core_kbd_exe mini_core_kbd_exe (
  .Clock               (Clock              ),  //  input 
  .Rst                 (Rst                ),  //  input 
...
mini_core_kbd_csr mini_core_kbd_csr (
 .Clk                       (Clock                  ),  
 .Rst                       (Rst                    ),  
 .PcQ102H                   (PcQ102H                ), 
...
//////////////////////////////////////////////////////////////////////////////////////////////////
mini_core_kbd_mem_acs1 mini_core_kbd_mem_access1 (
  .Clock              (Clock),          //input 
  .Rst                (Rst),            //input  
  // Input Control Signals
  .Ctrl               (CtrlMem1),       //input
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
mini_core_kbd_mem_acs2 mini_core_kbd_mem_access2 (
  .Clock              (Clock),          //input 
  .Rst                (Rst),            //input  
  // Input Control Signals
...
//////////////////////////////////////////////////////////////////////////////////////////////////
mini_core_kbd_wb mini_core_kbd_wb
( 
